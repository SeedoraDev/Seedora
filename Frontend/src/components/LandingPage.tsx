  ...
  const features = [
    {
      ...
      description: "Advanced thermogram analysis using AI to detect diabetic foot ulcers without physical contact",
      icon: (
    ...
    },
    {
      ...
      description: "Identify potential issues before visible symptoms appear, preventing complications",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Get professional-grade analysis from anywhere, making healthcare more accessible",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Regular tracking and monitoring for diabetic patients at risk",
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
