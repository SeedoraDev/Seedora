...
export default function UploadPage({ onBack }: UploadPageProps) {
  ...
  const saveAnalysisToStorage = (result: any) => {
    ...
    localStorage.setItem('seedora_analyses', JSON.stringify(existingAnalyses))
  }

  // Save analysis when results are available
  useEffect(() => {
    if (analysisState.result && patientData) {
      saveAnalysisToStorage(analysisState.result)
    }
  }, [analysisState.result, patientData])
              ...
              <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-gradient-to-br from-white/[0.08] to-white/[0.02] backdrop-blur-xl rounded-3xl border border-white/[0.12] shadow-2xl overflow-hidden">
                  <div className="p-8 pb-6">
                    ...
                    <div
                      className={`relative border-2 border-dashed rounded-2xl transition-all duration-500 min-h-[320px] flex flex-col justify-center ${dragActive
                ...
                <div className="mt-8 flex justify-center">
                  <button
                    ...
                    className={`flex items-center gap-2 px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 ${selectedFile && !analysisState.isAnalyzing
                ...
                <div className="bg-gradient-to-br from-white/[0.06] to-white/[0.02] backdrop-blur-xl rounded-2xl border border-white/[0.1] p-8">
                  <div className="grid lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="text-center">
                      ...
                      <div
                        className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium ${(analysisState.result?.prediction || 0) < 30
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center justify-between p-3 bg-white/[0.04] rounded-lg">
                            ...
                            <span className="text-white text-sm">{patientData?.name || 'Unknown'}</span>
                          </div>
                          <div className="flex items-center justify-between p-3 bg-white/[0.04] rounded-lg">
